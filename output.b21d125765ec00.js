    ...
    Object.defineProperties(a, {
        ...
        version: {
            get: Object(o.D)(function(t, e) {
                ...
                n && (-1 !== (o = n.indexOf(";")) && (n = n.substring(0, o)),
...
, function(t, e, n) {
    ...
    function s(t, e) {
        ...
        function(t, e) {
            if (!e)
                return;
            for (var n = document.createDocumentFragment(), r = l(e).childNodes, i = 0; i < r.length; i++)
    ...
    function T(t, e) {
        ...
        r.target = e,
        r = Object(i.k)(r, n),
        u.Browser.firefox ? r.dispatchEvent(new MouseEvent("click",{
            bubbles: !0,
            cancelable: !0,
            view: window
        })) : r.click()
        ...
        return s || (s = function(t) {
            ...
            if (e && s && f)
                return p = n.e(6).then(function(t) {
                    n(37);
                    var e = n(22).default;
                    return a.a.controls = n(21).default,
...
, function(t, e, n) {
    ...
    function c(t) {
        ...
        if ("string" == typeof t && t.length < 6) {
            ...
            if ("false" === e)
                return !1;
            if (!Object(i.v)(Number(t)) && !Object(i.v)(parseFloat(t)))
                return Number(t)
        }
        return t
    }
    ...
    function l(t, e) {
        if (t <= 0 && !e || Object(i.v)(parseInt(t)))
            return "00:00";
        var n = t < 0 ? "-" : "";
        t = Math.abs(t);
...
, function(t, e, n) {
    ...
    var d = function(t, e, n) {
        ...
        this.load = function() {
            var r = u[t];
            return 0 !== i ? r : (r && r.then(p).catch(d),
            i = 1,
...
, function(t, e, n) {
    ...
    function w(t, e, n) {
        ...
        if (!n.requireValidXML || "parsererror" !== i.nodeName && !i.getElementsByTagName("parsererror").length)
            return t.responseXML || (t = Object(r.k)({}, t, {
                responseXML: e
            })),
            n.oncomplete(t);
        j(n, u.o, h)
...
, function(t, e, n) {
    ...
    function l(t, e, n) {
        return delete Object(r.k)({}, n).playlist,
        t.map(function(t) {
            return d(e, t, n)
        }).filter(function(t) {
            return !!t
...
, function(t, e, n) {
    ...
    var h, v, g = "ontouchstart"in window, b = "PointerEvent"in window && !r.OS.android, m = !(b || g && r.OS.mobile), y = "window", j = "keydown", w = r.Features.passiveEvents, O = !!w && {
        passive: !0
    }, k = 6, C = 300, P = 500, x = function(t) {
        function e(t, n) {
            var r;
            !function(t, e) {
                if (!(t instanceof e))
        ...
        (r = [{
            ...
            value: function(t, n, r) {
                return E(t) && (this.handlers[t] || A[t](this)),
    ...
    var u = function t(e, n) {
        ...
        for (var s = 0; s < Object(r.c)(e); s++) {
            ...
            if ("media" === l.prefix) {
                ...
                case "content":
                    if (Object(i.j)(l, "duration") && (n.duration = Object(i.g)(Object(i.j)(l, "duration"))),
                    Object(i.j)(l, "url")) {
                        n.sources || (n.sources = []);
                        var f = {
                ...
                case "subtitle":
                    var p = {};
                    p.file = Object(i.j)(l, "url"),
                    p.kind = "captions",
                    Object(i.j)(l, "lang").length > 0 && (p.label = (u = Object(i.j)(l, "lang"),
                    a = void 0,
                    (a = {
                        zh: "Chinese",
                        nl: "Dutch",
...
, function(t, e, n) {
    ...
    var d = function(t, e) {
        ...
        h.volume = Object(r.A)(h.volume) ? Math.min(Math.max(0, h.volume), 100) : l.volume,
        h.mute = !!h.mute,
        h.language = d,
        h.intl = p;
        var v = i.autoPause;
        ...
        delete h.duration;
        var j = h.liveTimeout;
        null !== j && (Object(r.A)(j) ? 0 !== j && (j = Math.max(30, j)) : j = null,
        h.liveTimeout = j);
        var w, O, k = parseFloat(h.bandwidthEstimate), C = parseFloat(h.bitrateSelection);
        return h.bandwidthEstimate = Object(r.A)(k) ? k : (w = h.defaultBandwidthEstimate,
        O = parseFloat(w),
        Object(r.A)(O) ? Math.max(O, 1) : l.bandwidthEstimate),
        h.bitrateSelection = Object(r.A)(C) ? C : l.bitrateSelection,
        h.backgroundLoading = Object(r.s)(h.backgroundLoading) ? h.backgroundLoading : a.Features.backgroundLoading,
        h
    }
      , p = n(26)
      , h = n(8)
    ...
    var O = function(t, e) {
        var i, u = d(t, e), a = u.key || window.jwplayer && window.jwplayer.key, c = new p.b(a), s = c.edition();
        if (u.key = a,
        u.edition = s,
        u.error = c.error(),
        "unlimited" === s) {
        ...
        i = u.playlist,
        Object(r.y)(i) && i.indexOf(g) > -1 && (u.playlist = function(t, e) {
    ...
    function M(t) {
        return D(t) ? Promise.resolve() : A(t).then(function() {
            if (t.get("drm") || Object(I.b)(t.get("playlist")))
                return Object(I.d)(t.get("edition"))
        }).then(function() {
    ...
    function N(t, e) {
        var n = [L(t)];
        return D(t) || n.push(Promise.resolve()),
        Promise.all(n)
    }
    function L(t) {
        var e = t.attributes
        ...
        if (n && n.code === p.a) {
            ...
            if (i > 0 && i < 4 && r && o.duration() > -7776e6)
                return new E.a("//content.jwplatform.com/libraries/".concat(r, ".js")).load().then(function() {
    ...
    var R = function(t) {
        ...
        if ("string" == typeof e && !function(t) {
            ...
            return new E.a(e,!0).load().catch(function(t) {
                return t
            });
        return Promise.resolve()
    }
    ...
    var nt = function(t) {
        this._events = {},
        this.modelShim = new H.a,
        this.modelShim._qoeItem = new V.a,
        this.mediaShim = {},
    ...
    function rt(t, e) {
        ...
        console.error(T.s.logMessage(e.code)))
    }
    function it(t) {
    ...
    Object(r.k)(nt.prototype, {
        ...
        init: function(t, e) {
            ...
            Object(r.k)(this.mediaShim, Y.a);
            var a = t
              , c = O(Object(r.k)({}, t), u);
            c.id = e.id,
            c.setupConfig = a,
            Object(r.k)(i.attributes, c, Y.b),
            ...
            return i.on("change:errorEvent", rt),
            this.setup.start(e).then(function(t) {
                var u = t.core;
                if (!u)
                    throw Object(T.z)(null, T.w);
                if (n.setup) {
                    n.on(P.ub, it),
                    ...
                    n.apiQueue.destroy(),
                    Object(r.k)(n, u.prototype),
                    n.setup(a, e, n.originalContainer, n._events, c, s);
                    var l = n._model;
                    return i.off("change:errorEvent", rt),
                    l.on("change:errorEvent", rt),
                    o.track(l),
                ...
                n.setup && function(t, e, n) {
                    Promise.resolve().then(function() {
                        ...
                        if (!o) {
                            ...
                            J.a.cloneIcon && u.querySelector(".jw-icon").appendChild(J.a.cloneIcon("error")),
                            ot(t, u)
                        }
                        i.set("errorEvent", r),
                        i.set("state", P.mb),
        ...
        playerDestroy: function() {
            ...
            this.currentContainer !== this.originalContainer && ot(this, this.originalContainer),
            this.off(),
...
, function(t, e, n) {
    "use strict";
    var r, i = n(60), o = n(5), u = [], a = [], c = {}, s = "screen"in window && "orientation"in window.screen, l = o.OS.android && o.Browser.chrome;
    function f(t, e) {
    ...
    document.addEventListener("webkitvisibilitychange", p),
    l && s && window.screen.orientation.addEventListener("change", d),
    window.addEventListener("beforeunload", function() {
        document.removeEventListener("visibilitychange", p),
        document.removeEventListener("webkitvisibilitychange", p),
        l && s && window.screen.orientation.removeEventListener("change", d)
    }),
    e.a = {
        add: function(t) {
            u.push(t)
...
, function(t, e, n) {
    ...
    Object(r.k)(Q.prototype, {
        ...
        trigger: function(t, e) {
            return (e = r.g.isObject(e) ? Object(r.k)({}, e) : {}).type = t,
    ...
    et.utils.css.style = et.utils.style,
    et.vid = Z.a;
    var nt = et
      , rt = n(61)
        ...
        r.forEach(function(i) {
            "function" == typeof n[i] && "Events" !== i ? t[i] = function t(e, n, r, i) {
                return function() {
                    ...
                    var l = n[r].apply(n, o);
                    return "remove" === r ? n.off.call(e) : "setup" === r && (n.off.call(e),
                    n.off(u.events, null, n),
                    n.on.call(e, u.events, null, e),
                    n.on("all", function(r, o) {
                        if ("ready" === r) {
    ...
    Object(r.k)(lt, nt),
    U(lt),
    "function" == typeof st.define && st.define.amd && st.define([], function() {
        return lt
    });
    var ft = lt;
...
;var odkBanner = (function($) {
    var $banner = $('<div class="bi-overlaybanner"></div>');
    return {
        overlayBanner: {
            init: function() {
                var $player = $('#video_player');
                $.get('/common/banner_pick/?placement=player_overlay').done(function(data) {
                    if (data.trim()) {
                        $banner.html(data);
                        $player.append($banner);
                        dataLayer.push({
                            event: 'overlayBannerImpression'
                        });
                        setTimeout(function() {
                            $banner.remove();
                        }, 3000);
            ...
            fullscreen: function(isFullSize) {
                if (isFullSize) {
                    $banner.addClass('fullsize');
                } else {
                    $banner.removeClass('fullsize');
                }
            }
        },
        longBanner: {
            init: function($wrapper) {
                $wrapper.on('click', '.banner-button-wrapper', function(event) {
                    event.preventDefault();
                    event.stopPropagation();
                    Cookies.set('noti_closed', true, {
                        path: '/',
                        expires: 1
                    });
                    $wrapper.remove();
...
;var odkPlayer = (function() {
    var isBlock = false;
    var chkUrls = ['https://production-static.ondemandkorea.com/images/ads-sponsor-300x250.jpg', 'https://www.google-analytics.com/collect'];
    ...
    var detector = (function() {
        chkUrls.forEach(function(url) {
            checkURLBlocked(url);
        });
        return {
            check: function() {
                if (isBlock || !pbjs.libLoaded || !googletag._loadStarted_ || typeof apstag.bids === 'undefined') {
                    return false;
                }
                return false;
            }
    ...
    var playlist = null;
    var lastPlayPos = 0;
    var isSubscriptionMember = false;
    ...
    function showAdBlockMessage() {
        if (isSubscriptionMember || hasPassFlag) {
            return;
        }
    ...
    function onTickTimer() {
        recordPlayingTime();
        var playingTime = _.reduce(playingSeconds, function(memo, num) {
            return memo + num;
        }, 0);
    ...
    $(window).bind('beforeunload', function() {
        ...
        if (typeof cast !== 'undefined' && cast.framework) {
            try {
                ...
                var controller = new cast.framework.RemotePlayerController(remotePlayer);
                controller.stop();
    ...
    return {
        setConfig: function(_episodeId, _continueWatchingUrl, _nextUrl, _logUrls, _loginBtnCode, _isMember, _hasPassFlag, _messages, _cdnProvider, _googleAdTag) {
        ...
        init: function(_playlist) {
            playlist = _playlist;
            if (adultOnlyHtml) {
                $('#video_player').append(adultOnlyHtml);
                return this.initEventsForAdultOnly();
            }
            if ($('#video_player').length) {
                this.initPlayer();
            }
        },
        initEventsForAdultOnly: function() {
            $('#playback_app .adult-only .btn-back').one('click', function(e) {
                history.back();
            });
            $('#playback_app .adult-only .btn-over-18').one('click', function(e) {
                odkPlayer.initPlayer();
            });
        },
        initPlayer: function() {
            player.setup({
                ...
                cast: isSubscriptionMember ? {} : null,
                captions: {
                    color: '#FFFFFF',
                    fontSize: 14,
            ...
            player.on('adCompanions', odkPlayer.onAdCompanions);
            player.on('adSkipped', hideCompanion);
            player.on('adComplete', odkPlayer.onAdComplete);
            player.on('adRequest', odkPlayer.onAdRequest);
            player.on('adError', odkPlayer.onAdError);
            player.on('adImpression', odkPlayer.onAdImpression);
            player.on('fullscreen', odkPlayer.onFullScreen);
            player.on('buffer ', odkPlayer.onBuffer);
            player.on('visualQuality', odkPlayer.onVisualQuality);
            if (loginBtnCode) {
                player.addButton('', 'Login', function() {
                    window.location = '/includes15/login?next=' + window.location.pathname;
                }, 'login', 'jw-login-icon-' + loginBtnCode);
            }
        ...
        onTime: function(e) {
            ...
            if (curPos === 1 && !bannerCalled) {
                odkBanner.overlayBanner.init();
                bannerCalled = true;
            }
            if (Math.floor(e.position % 30) === 0) {
                odkPlayer.sendUserContinueWatching(curPos);
            }
            Cookies.set('last_position', episodeId + '|' + curPos, {
                expires: 10
            });
            lastPlayPos = curPos;
        },
        ...
        onSetupError: function(e) {
            var errorMessage = 'The video cannot be played because your device or browser is out-of-date. <br>' + 'Please update your device or browser and try again. <br><br>' + 'You can enjoy OnDemandKorea on our mobile app, Roku and Apple TV.';
        ...
        onCaptionsChanged: function(e) {
            ...
            dataLayer.push({
                event: 'videoCaptionChanged'
            });
        },
        onAdCompanions: function(e) {
            if (e.companions) {
                for (var i in e.companions) {
                    var companion = e.companions[i];
                    if (companion.width === 300 && companion.height === 250) {
                        showCompanion();
                        break;
                    }
                }
        ...
        onAdImpression: function(e) {
            ...
            dataLayer.push({
                ...
                adTitle: e.adtitle,
                adWrapperId: imaAd.adWrapperIds[0] || imaAd.adId
            });
        },
        onAdBlock: function(e) {
            //showAdBlockMessage();
			return;
        },
        onAdRequest: function(e) {
            isValidRequest = true;
        },
        ...
        onFullScreen: function(e) {
            odkBanner.overlayBanner.fullscreen(e.fullscreen);
            dfp_dict['fullscreen'] = e.fullscreen ? '1' : '0';
        },
        onBuffer: function(e) {
...
;var odkSidebanner = (function() {
    var plus = 0;
    var locale = '';
    function loadSideBanner() {
        var bannerUrl = 'https://banner.ondemandkorea.com';
        var url = bannerUrl + '/ads/new_sidebanner.php';
        $.post(url, {
            lang: locale,
            plus: plus,
            request_name: ''
            ...
            if (_.isObject(data)) {
                _.each(data, function(value, key) {
                    var imgSrc = bannerUrl + value.src;
                    var url = bannerUrl + '/ads/new_sidebanner_click.php?plus=' + plus + '&id=' + value.id;
                    var imgTag = ['<a href="' + url + '" class="bi-plyer-sideAd01" target="_blank">', '<img src="' + imgSrc + '">', '</a>'].join('');
                    $('#' + key).html(imgTag);
                });
            }
        });
    ...
    return {
        init: function(nPlus, sLocale) {
            plus = nPlus;
            locale = sLocale;
            loadSideBanner();
            setInterval(loadSideBanner, 450000);
        }
    };
}
)();
